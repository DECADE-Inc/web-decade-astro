...
import logoKomunitas from "../../../../public/img/tentang/logo_komunitas biru.png"
import kedua from "../../../../public/img/tentang/kedua.png"
          ...
          <SwiperSlide>
            <div className=" relative w-full bg-white text-black dark:bg-black dark:text-white rounded-2xl px-4 sm:px-6 lg:px-16 flex items-center justify-center min-h-[600px] lg:min-h-[550px] overflow-hidden">
              <img
                src={kedua.src}
                alt="Background Icon"
                className="absolute opacity-80 w-[200px] sm:w-[250px] md:w-[300px] h-auto object-contain inset-0 m-auto pointer-events-none"
              />
